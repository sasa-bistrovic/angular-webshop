...
public class RedirectController {
    ...
    public void serveIndex(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (hasRedirected1 == null || !hasRedirected1) {
            if (url != null && !url.contains("https://webshop.expense-tracking.com")) {
        ...
        if (hasRedirected1 == null || !hasRedirected1) {
           ...
           if (host != null && host.contains("herokuapp") || url != null && url.contains("herokuapp")) {
               session.setAttribute("hasRedirected1", true);
               response.sendRedirect("https://webshop-1ecbcf6a837b.herokuapp.com");
            }   
           if (host != null && host.contains("webshop.expense-tracking.com") || url != null && url.contains("webshop.expense-tracking.com")) {
               session.setAttribute("hasRedirected1", true);
               response.sendRedirect("https://webshop.expense-tracking.com");
            } else                      
